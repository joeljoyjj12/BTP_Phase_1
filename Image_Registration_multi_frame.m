...
I=Data.ImgData;
I_fixed=US_image(I(:,:,360));
I_moving=US_image(I(:,:,440));
...
%{
I_fixed=US_image(Data_P1.ImgData(:,:,1));
I_moving=US_image(Data_P2.ImgData(:,:,1));
%}
...
I_fixed_dup=zeros(500,460);
I_moving_dup=zeros(500,460);
I_fixed_dup((500-384)/2:(500-384)/2+384-1,180:180+128-1)=I_fixed;
I_moving_dup((500-384)/2:(500-384)/2+384-1,180:180+128-1)=I_moving;
